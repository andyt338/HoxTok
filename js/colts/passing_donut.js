...
function selectData2() {
	...
	passingStats.push({week:50, name:"A. Luck", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"M. Hasselbeck", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"C. Whitehurst", cmp:0, att:0, yds:0, td:0, int:0, color:"#3aaa2f"});
	passingStats.push({week:50, name:"J. Freeman", cmp:0, att:0, yds:0, td:0, int:0, color:"#21aa2f"});
	passingStats.push({week:50, name:"R. Lindley", cmp:0, att:0, yds:0, td:0, int:0, color:"#4daa2f"});
...
d3.tsv("/data/colts/passing.txt", function(data) {
	stats2 = data;
