...
function selectData1() {
	...
	rushingStats.push({week:50, name:"D. Martin", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"C. Sims", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"J. Winston", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"B. Rainey", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"J. Lane", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
...
d3.tsv("/data/buccaneers/rushing.txt", function(data) {
	stats1 = data;
