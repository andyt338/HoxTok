...
function selectData2() {
	...
	passingStats.push({week:50, name:"J. Manziel", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"J. McCown", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"A. Davis", cmp:0, att:0, yds:0, td:0, int:0, color:"#343fdb"});
...
d3.tsv("/data/browns/passing.txt", function(data) {
	stats2 = data;
