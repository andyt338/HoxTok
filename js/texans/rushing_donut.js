...
function selectData1() {
	...
	rushingStats.push({week:50, name:"A. Blue", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"C. Polk", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"A. Foster", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"J. Grimes", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"A. Hunt", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"B. Hoyer", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"C. Shorts III", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"B. Weeden", att:0, yds:0, td:0, lg:0, color:"#79c725"});
	rushingStats.push({week:50, name:"J. Prosch", att:0, yds:0, td:0, lg:0, color:"#dff429"});
	rushingStats.push({week:50, name:"B. Daniels", att:0, yds:0, td:0, lg:0, color:"#f2823a"});
	rushingStats.push({week:50, name:"T. Yates", att:0, yds:0, td:0, lg:0, color:"#a7d52a"});
...
d3.tsv("/data/texans/rushing.txt", function(data) {
	stats1 = data;
