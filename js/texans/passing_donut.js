...
function selectData2() {
	...
	passingStats.push({week:50, name:"B. Hoyer", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"T. Yates", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"B. Weeden", cmp:0, att:0, yds:0, td:0, int:0, color:"#12aa2f"});
	passingStats.push({week:50, name:"B. Daniels", cmp:0, att:0, yds:0, td:0, int:0, color:"#23aa2f"});
	passingStats.push({week:50, name:"C. Shorts III", cmp:0, att:0, yds:0, td:0, int:0, color:"#34aa2f"});
	passingStats.push({week:50, name:"J. Grimes", cmp:0, att:0, yds:0, td:0, int:0, color:"#45aa2f"});
...
d3.tsv("/data/texans/passing.txt", function(data) {
	stats2 = data;
