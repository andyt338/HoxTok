...
function selectData2() {
	...
	passingStats.push({week:50, name:"R. Wilson", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"T. Jackson", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
...
d3.tsv("/data/seahawks/passing.txt", function(data) {
	stats2 = data;
