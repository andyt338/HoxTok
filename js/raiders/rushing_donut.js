...
function selectData1() {
	...
	rushingStats.push({week:50, name:"L. Murray", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"D. Carr", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"J. Olawale", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"R. Helu", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"T. Jones", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"M. Reece", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"A. Cooper", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"C. Woodson", att:0, yds:0, td:0, lg:0, color:"#79c725"});
...
d3.tsv("/data/raiders/rushing.txt", function(data) {
	stats1 = data;
