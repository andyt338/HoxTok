...
function selectData2() {
	...
	passingStats.push({week:50, name:"A. Smith", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"C. Daniel", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"C. Santos", cmp:0, att:0, yds:0, td:0, int:0, color:"#23aa2f"});
...
d3.tsv("/data/chiefs/passing.txt", function(data) {
	stats2 = data;
