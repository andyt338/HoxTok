...
function selectData1() {
	...
	rushingStats.push({week:50, name:"D. Freeman", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"T. Coleman", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"M. Ryan", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"T. Ward", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"E. Weems", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"P. DiMarco", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"S. Renfree", att:0, yds:0, td:0, lg:0, color:"#fad435"});
...
d3.tsv("/data/falcons/rushing.txt", function(data) {
	stats1 = data;
