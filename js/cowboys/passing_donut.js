...
function selectData2() {
	...
	passingStats.push({week:50, name:"M. Cassel", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"T. Romo", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"K. Moore", cmp:0, att:0, yds:0, td:0, int:0, color:"#321a2f"});
	passingStats.push({week:50, name:"D. McFadden", cmp:0, att:0, yds:0, td:0, int:0, color:"#123a2f"});
...
d3.tsv("/data/cowboys/passing.txt", function(data) {
	stats2 = data;
