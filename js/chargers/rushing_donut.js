...
function selectData1() {
	...
	rushingStats.push({week:50, name:"M. Gordon", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"D. Woodhead", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"D. Brown", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"B. Oliver", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"P. Rivers", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"D. Johnson", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"J. Herndon", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"K. Clemens", att:0, yds:0, td:0, lg:0, color:"#79c725"});
...
d3.tsv("/data/chargers/rushing.txt", function(data) {
	stats1 = data;
