...
function selectData2() {
	...
	passingStats.push({week:50, name:"P. Rivers", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"K. Clemens", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
...
d3.tsv("/data/chargers/passing.txt", function(data) {
	stats2 = data;
