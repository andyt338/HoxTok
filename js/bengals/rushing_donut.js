...
function selectData1() {
	...
	rushingStats.push({week:50, name:"J. Hill", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"G. Bernard", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"A. Dalton", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"A. McCarron", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"M. Sanu", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"M. Jones", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"R. Burkhead", att:0, yds:0, td:0, lg:0, color:"#fad435"});
...
d3.tsv("/data/bengals/rushing.txt", function(data) {
	stats1 = data;
