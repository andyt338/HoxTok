...
function selectData2() {
	...
	passingStats.push({week:50, name:"T. Bridgewater", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"S. Hill", cmp:0, att:0, yds:0, td:0, int:0, color:"#1277c4"});
...
d3.tsv("/data/vikings/passing.txt", function(data) {
	stats2 = data;
