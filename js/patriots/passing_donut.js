...
function selectData2() {
	...
	passingStats.push({week:50, name:"T. Brady", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"J. Garoppolo", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"D. Amendola", cmp:0, att:0, yds:0, td:0, int:0, color:"#12aa2f"});
...
d3.tsv("/data/patriots/passing.txt", function(data) {
	stats2 = data;
