...
function selectData1() {
	...
	rushingStats.push({week:50, name:"C. Ivory", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"B. Powell", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"R. Fitzpatrick", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"S. Ridley", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"Z. Stacy", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"G. Smith", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"T. Bohanon", att:0, yds:0, td:0, lg:0, color:"#fad435"});
...
d3.tsv("/data/jets/rushing.txt", function(data) {
	stats1 = data;
