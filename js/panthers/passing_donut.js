...
function selectData2() {
	...
	passingStats.push({week:50, name:"C. Newton", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"D. Anderson", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
...
d3.tsv("/data/panthers/passing.txt", function(data) {
	stats2 = data;
