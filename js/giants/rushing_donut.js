...
function selectData1() {
	...
	rushingStats.push({week:50, name:"R. Jennings", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"A. Williams", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"S. Vereen", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
...
d3.tsv("/data/giants/rushing.txt", function(data) {
	stats1 = data;
