...
function selectData() {
	...
	receivingStats.push({week:50, name:"D. Harris", rec:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	receivingStats.push({week:50, name:"R. Jennings", rec:0, yds:0, td:0, lg:0, color:"#f25e40"});
	receivingStats.push({week:50, name:"L. Donnell", rec:0, yds:0, td:0, lg:0, color:"#fad435"});
	receivingStats.push({week:50, name:"J. Cunningham", rec:0, yds:0, td:0, lg:0, color:"#79c725"});
	receivingStats.push({week:50, name:"M. White", rec:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	receivingStats.push({week:50, name:"H. Nicks", rec:0, yds:0, td:0, lg:0, color:"#f2823a"});
	receivingStats.push({week:50, name:"D. Fells", rec:0, yds:0, td:0, lg:0, color:"#a7d52a"});
	receivingStats.push({week:50, name:"P. Parker", rec:0, yds:0, td:0, lg:0, color:"#7328b6"});
	receivingStats.push({week:50, name:"O. Darkwa", rec:0, yds:0, td:0, lg:0, color:"#f6c137"});
	receivingStats.push({week:50, name:"M. LaCosse", rec:0, yds:0, td:0, lg:0, color:"#53c025"});
	receivingStats.push({week:50, name:"G. Davis", rec:0, yds:0, td:0, lg:0, color:"#4daecf"});
	receivingStats.push({week:50, name:"B. Edwards", rec:0, yds:0, td:0, lg:0, color:"#f69537"});
	receivingStats.push({week:50, name:"A. Williams", rec:0, yds:0, td:0, lg:0, color:"#3438bd"});
	receivingStats.push({week:50, name:"E. Flowers", rec:0, yds:0, td:0, lg:0, color:"#fdf32f"});
...
d3.tsv("/data/giants/receiving.txt", function(data) {
	stats = data;
