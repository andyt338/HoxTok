...
function selectData2() {
	...
	passingStats.push({week:50, name:"J. Flacco", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"R. Mallett", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"J. Clausen", cmp:0, att:0, yds:0, td:0, int:0, color:"#12aa2f"});
	passingStats.push({week:50, name:"M. Schaub", cmp:0, att:0, yds:0, td:0, int:0, color:"#23aa2f"});
	passingStats.push({week:50, name:"S. Koch", cmp:0, att:0, yds:0, td:0, int:0, color:"#34aa2f"});
...
d3.tsv("/data/ravens/passing.txt", function(data) {
	stats2 = data;
