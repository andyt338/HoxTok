...
function selectData1() {
	...
	rushingStats.push({week:50, name:"L. McCoy", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"T. Taylor", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"K. Williams", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"M. Gillislee", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"A. Dixon", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"E. Manuel", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"P. Harvin", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"C. Wood", att:0, yds:0, td:0, lg:0, color:"#79c725"});
	rushingStats.push({week:50, name:"C. Hogan", att:0, yds:0, td:0, lg:0, color:"#dff429"});
	rushingStats.push({week:50, name:"J. Felton", att:0, yds:0, td:0, lg:0, color:"#f2823a"});
	rushingStats.push({week:50, name:"S. Watkins", att:0, yds:0, td:0, lg:0, color:"#a7d52a"});
	rushingStats.push({week:50, name:"C. Schmidt", att:0, yds:0, td:0, lg:0, color:"#3438bd"});
	rushingStats.push({week:50, name:"R. Woods", att:0, yds:0, td:0, lg:0, color:"#fdf32f"});
	rushingStats.push({week:50, name:"M. Thigpen", att:0, yds:0, td:0, lg:0, color:"#f69537"});
...
d3.tsv("/data/bills/rushing.txt", function(data) {
	stats1 = data;
