...
function selectData2() {
	...
	passingStats.push({week:50, name:"T. Taylor", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"E. Manuel", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"C. Hogan", cmp:0, att:0, yds:0, td:0, int:0, color:"#460687"});
...
d3.tsv("/data/bills/passing.txt", function(data) {
	stats2 = data;
