...
function selectData2() {
	...
	passingStats.push({week:50, name:"B. Roethlisberger", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"M. Vick", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"L. Jones", cmp:0, att:0, yds:0, td:0, int:0, color:"#12aa2f"});
...
d3.tsv("/data/steelers/passing.txt", function(data) {
	stats2 = data;
