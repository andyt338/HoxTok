...
function selectData1() {
	...
	rushingStats.push({week:50, name:"M. Ingram", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"T. Hightower", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"K. Robinson", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"C. Spiller", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"D. Brees", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"B. Cooks", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"T. Cadet", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"A. Johnson", att:0, yds:0, td:0, lg:0, color:"#79c725"});
	rushingStats.push({week:50, name:"K. Hunter", att:0, yds:0, td:0, lg:0, color:"#dff429"});
	rushingStats.push({week:50, name:"M. Hoomanawanui", att:0, yds:0, td:0, lg:0, color:"#f2823a"});
	rushingStats.push({week:50, name:"M. Murphy", att:0, yds:0, td:0, lg:0, color:"#a7d52a"});
...
d3.tsv("/data/saints/rushing.txt", function(data) {
	stats1 = data;
