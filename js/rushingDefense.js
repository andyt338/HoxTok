...
function run10() {
  ...
  var svg = d3.select("#rushingDefense").append("svg")
  ...
  var e = document.getElementById("rushingDefenseCategory");
  var category = e.options[e.selectedIndex].value;

  d3.csv("/data/miscellaneous_data/rushing_defense_2015.csv", type, function(error, data) {
    ...
    svg.selectAll(".bar_rushingDefense")
        .data(data)
      .enter().append("rect")
        .attr("class", "bar_rushingDefense")
...
function run11(){
  ...
  d3.csv("/data/miscellaneous_data/rushing_defense_2015.csv", function(error, data) {
    ...
    x.domain(data.map(function(d) { return d.Team; }));
    y.domain([0, d3.max(data, function(d) { return d.frequency; })]);
    var svg = d3.select("#rushingDefense").transition();
    count = 0;
