...
function selectData1() {
	...
	rushingStats.push({week:50, name:"L. Miller", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"J. Ajayi", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"R. Tannehill", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"J. Landry", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"D. Williams", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"M. Moore", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"R. Matthews", att:0, yds:0, td:0, lg:0, color:"#fad435"});
...
d3.tsv("/data/dolphins/rushing.txt", function(data) {
	stats1 = data;
