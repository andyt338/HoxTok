...
function run8() {
  ...
  var svg = d3.select("#rushingOffense").append("svg")
  ...
  var e = document.getElementById("rushingOffenseCategory");
  var category = e.options[e.selectedIndex].value;

  d3.csv("/data/miscellaneous_data/rushing_offense_2015.csv", type, function(error, data) {
    ...
    svg.selectAll(".bar_rushingOffense")
        .data(data)
      .enter().append("rect")
        .attr("class", "bar_rushingOffense")
...
function run9(){
  ...
  d3.csv("/data/miscellaneous_data/rushing_offense_2015.csv", function(error, data) {
    ...
    x.domain(data.map(function(d) { return d.Team; }));
    y.domain([0, d3.max(data, function(d) { return d.frequency; })]);
    var svg = d3.select("#rushingOffense").transition();
    count = 0;
