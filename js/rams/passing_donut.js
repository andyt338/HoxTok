...
function selectData2() {
	...
	passingStats.push({week:50, name:"N. Foles", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"C. Keenum", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"S. Mannion", cmp:0, att:0, yds:0, td:0, int:0, color:"#23aa2f"});
	passingStats.push({week:50, name:"J. Hekker", cmp:0, att:0, yds:0, td:0, int:0, color:"#51aa2f"});
...
d3.tsv("/data/rams/passing.txt", function(data) {
	stats2 = data;
