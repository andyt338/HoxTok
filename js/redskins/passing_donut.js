...
function selectData2() {
	...
	passingStats.push({week:50, name:"K. Cousins", cmp:0, att:0, yds:0, td:0, int:0, color:"#3f77c4"});
	passingStats.push({week:50, name:"C. McCoy", cmp:0, att:0, yds:0, td:0, int:0, color:"#f4aa2f"});
	passingStats.push({week:50, name:"J. Crowder", cmp:0, att:0, yds:0, td:0, int:0, color:"#12aa2f"});
...
d3.tsv("/data/redskins/passing.txt", function(data) {
	stats2 = data;
