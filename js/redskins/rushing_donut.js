...
function selectData1() {
	...
	rushingStats.push({week:50, name:"A. Morris", att:0, yds:0, td:0, lg:0, color:"#ef3c42"});
	rushingStats.push({week:50, name:"M. Jones", att:0, yds:0, td:0, lg:0, color:"#52c67f"});
	rushingStats.push({week:50, name:"C. Thompson", att:0, yds:0, td:0, lg:0, color:"#3f77c4"});
	rushingStats.push({week:50, name:"K. Cousins", att:0, yds:0, td:0, lg:0, color:"#ffff2d"});
	rushingStats.push({week:50, name:"P. Thomas", att:0, yds:0, td:0, lg:0, color:"#f4aa2f"});
	rushingStats.push({week:50, name:"D. Young", att:0, yds:0, td:0, lg:0, color:"#f25e40"});
	rushingStats.push({week:50, name:"C. McCoy", att:0, yds:0, td:0, lg:0, color:"#fad435"});
	rushingStats.push({week:50, name:"J. Crowder", att:0, yds:0, td:0, lg:0, color:"#79c725"});
...
d3.tsv("/data/redskins/rushing.txt", function(data) {
	stats1 = data;
